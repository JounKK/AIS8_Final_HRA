...
| 2. **HR 시각화 대시보드** <br> 다양한 HR 데이터를 대시보드로 제작해 전 직원을 효율적으로 관리할 수 있다. 이는 실무진이 실시간 HR 데이터를 살펴보며 개인, 조직, 회사의 개선 사항이 무엇인지 단계별로 찾을 수 있도록 도와준다. 이를 테면, 퇴사율이 높은 직무를 중심으로 퇴사 원인을 탐색하여 일괄적인 해결방안(ex. 연봉상승) 대신 구체적인 조치를 취할 수 있다. | <img src="https://user-images.githubusercontent.com/125840482/236967300-22b7ad7f-bbac-4ad8-ae00-7dfa02372265.png" width="400" height="200"> <br> 이미지 출처 : [https://www.simplesheets.co/hr-metrics-dashboard](https://www.simplesheets.co/hr-metrics-dashboard)|<br/><br/><br/>
